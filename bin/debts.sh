...
fixmes=$(grep -r FIXME: ./src --exclude=*{.snap,.md} --exclude-dir=coverage --exclude-dir=bin | wc -l)
todos=$(grep -r TODO: ./src --exclude=*{.snap,.md} --exclude-dir=coverage --exclude-dir=bin | wc -l)
total=$((fixmes+todos))
